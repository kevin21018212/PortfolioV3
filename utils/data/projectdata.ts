...
export const projectData: Project[] = [
  ...
  },
  {
    ...
    description:
      "The hardest part about creation is organization. Attempting to solve the bloat and boredom of modern task apps like Jira and Trello, DASH is designed to be an inviting and playful project management platform that its users actually want to use. With a simple and light interface, you can easily manage your projects, set deadlines, and track your progress. DASH is built using more advanced techniques like route caching, server-side rendering, and OAUTH to make the user experience not only as smooth as possible but also extremely fast and secure.",
  ...
  },
  {
    ...
    description:
      "Social media apps are so busy, I feel like every time I use one I get bombarded with an endless stream of people and things I don't care about. Inspired by BeReal, KevConnect is a closed ecosystem social media experience. Being invite-only, the only users on the platform are the people I regularly interact with. It's designed to give the benefits of a social media platform without all the clutter and noise. KevConnect is built using AWS, Okta, and Next.js to create a secure and fast platform that is designed to be used by a small group of people.",
  ...
  },
  {
    ...
    projectTag: "Mini Me",
    description:
      "AI is at the forefront of technology. KevBot is designed as an experiment to create a digital version of myself. I wanted to see if I could create a bot that could interface with Twitter.",
    projectTech: "ART",
    img1: "",
    img2: "",
    linkUrl: "",
